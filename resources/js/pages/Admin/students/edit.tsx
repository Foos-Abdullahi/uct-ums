...
import { Save, Loader2, User, GraduationCap, DollarSign } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-3">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Update profile details for {student.user?.name}{' '}
                                ({student.matric_no})
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(val) =>
                                        setData('current_semester', Number(val))
                                    }
                                >
                                    <SelectTrigger
                                        className="w-full"
