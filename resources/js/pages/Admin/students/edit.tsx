...
export default function AdminStudentsEdit({
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        enrollment_date: student.enrollment_date
            ? String(student.enrollment_date).split('T')[0]
            : '',
        graduation_date: student.graduation_date
            ? String(student.graduation_date).split('T')[0]
            : '',
    });
            ...
            <div className="mx-auto max-w-4xl space-y-6 p-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Update student information, program assignment,
                                semester, and status.
                            </p>
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <UctSectionCard
                        ...
                        description="Student identification and contact details."
                        error={Boolean(
                            errors.name ||
                            errors.email ||
                            errors.phone ||
                    ...
                    <UctSectionCard
                        step={2}
                        icon={GraduationCap}
                        title="Academic Record & Status"
                        description="Matriculation ID, academic program, and enrollment standing."
                        error={Boolean(
                            errors.matric_no ||
                            errors.program_id ||
