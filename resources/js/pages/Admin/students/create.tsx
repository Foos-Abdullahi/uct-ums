                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card className="rounded-sm border-border/40 bg-card shadow-xs">
                        <CardHeader className="pb-3">
                            ...
                            <CardDescription className="text-xs">
                                Academic program assignment and semester status.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="matric_no">
                                        Matriculation ID <span className="text-muted-foreground font-normal text-xs">(Leave empty for auto-generated)</span>
                                    </Label>
                                    <Input
                                        id="matric_no"
                    ...
                    <Card className="rounded-sm border-border/40 bg-card shadow-xs">
                        <CardHeader className="pb-3">
                            <CardTitle className="text-sm font-semibold">
                                3. Account Password & Tuition Invoice
                            </CardTitle>
                            <CardDescription className="text-xs">
                                Setup default account access and initial tuition invoice.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="grid gap-2">
                                    <Label htmlFor="password">
                                        Account Password <span className="text-muted-foreground font-normal text-xs">(Default: password123)</span>
                                    </Label>
                                    <Input
                                        id="password"
                                        type="password"
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <span className="text-[11px] text-muted-foreground">
                                        Creates an initial tuition invoice for Semester 1.
                                    </span>
...
AdminStudentsCreate.layout = { breadcrumbs };
