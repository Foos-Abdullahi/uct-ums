...
export default function AdminAdmissionsShow({
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: admission.application_no,
    ...
    const fullName =
        admission.full_name || `${admission.first_name} ${admission.last_name}`;
            ...
            <div className="mx-auto max-w-5xl space-y-6 p-6">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        {isEnrolled && admission.student_id && (
                            <Button size="sm" asChild>
                                <Link
                                    href={`/admin/students/${admission.student_id}`}
                                >
                ...
                <UctSectionCard contentClassName="p-6">
                    <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
                        ...
                        <div className="flex items-center gap-3 rounded-md border border-border/40 bg-muted/40 p-3">
                            <div className="text-left md:text-right">
                                ...
                                <p className="text-[11px] text-muted-foreground">
                                    {admission.entry_semester || 'Semester 1'}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex justify-between py-2">
                            ...
                            <span className="font-medium text-foreground">
                                {admission.date_of_birth
                                    ? String(admission.date_of_birth).split(
                                          'T',
                                      )[0]
                                    : '—'}
                            </span>
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <div className="flex justify-between py-2">
                                ...
                                <span className="font-medium text-foreground">
                                    {admission.previous_qualification || '—'}
                                </span>
                            </div>
                            <div className="flex justify-between py-2">
                                <span className="text-muted-foreground">
