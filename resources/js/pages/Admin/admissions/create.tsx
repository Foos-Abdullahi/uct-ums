...
export default function AdminAdmissionsCreate({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/admin/admissions', {
            onError: () => {
                toast.error(
                    'Please fix validation errors in the application form.',
                );
            },
        });
    };
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">
                                Register an incoming applicant into the
                                admissions pipeline.
                            </p>
                        </div>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="entry_semester">
                                    Entry Semester
                                </Label>
                                <Select
                                    value={data.entry_semester}
                                    onValueChange={(val) =>
                                        setData('entry_semester', val)
                                    }
                                >
                                    <SelectTrigger id="entry_semester">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div className="grid gap-2">
                                <Label htmlFor="previous_qualification">
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="previous_gpa">
                                    Prior GPA / Grade Score
                                </Label>
                                <Input
                                    id="previous_gpa"
                                    type="number"
                                    ...
                                    onChange={(e) =>
                                        setData('previous_gpa', e.target.value)
                                    }
                                />
                                {errors.previous_gpa && (
                                    <p className="text-xs text-destructive">
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="notes">
                                Applicant Notes / Personal Statement
                            </Label>
                            <textarea
                                id="notes"
                                rows={3}
