            ...
            <div className="space-y-6 p-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {/* Program Filter */}
                        <select
                            className="h-8 rounded-md border border-input bg-background px-3 py-1 text-xs shadow-sm focus:ring-1 focus:ring-ring focus:outline-none"
                    ...
                    {semesters.map((sem) => (
                        <UctPanelCard
                            ...
                            actions={
                                ...
                                >
                                    <Link
                                        href={`/admin/courses?semester=${sem.semester_number}`}
                                    >
                                        ...
                                        <div className="space-y-1">
                                            {sem.courses
                                                ...
                                                .map((c) => (
                                                    <div
                                                        key={c.id}
                                                        className="flex items-center justify-between rounded bg-muted/20 px-1.5 py-1 text-xs transition-colors hover:bg-muted/40"
                                                    >
