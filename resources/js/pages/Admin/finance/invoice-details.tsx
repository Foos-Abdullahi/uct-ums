...
export default function AdminInvoiceDetails({
    ...
    const updateItem = (
        index: number,
        field: keyof (typeof data.items)[0],
        value: string,
    ) => {
                                    ...
                                    {invoice.payments.map((payment) => (
                                        ...
                                        >
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2">
                                                    <div
                                                        className={`rounded-full p-1.5 ${payment.status === 'paid' ? 'bg-emerald-500/10 text-emerald-600' : payment.status === 'pending' ? 'bg-amber-500/10 text-amber-600' : 'bg-destructive/10 text-destructive'}`}
                                                    >
                                                        {payment.status ===
                                                        'paid' ? (
                    ...
                    <DialogContent className="max-h-[85vh] overflow-y-auto sm:max-w-2xl">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-xs">
                                Update invoice details, line items, tax, and
                                discount. Invoices with collected payments
                                cannot be edited.
                            </DialogDescription>
                        </DialogHeader>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    {data.items.map((item, index) => (
                                        <div
                                            key={index}
                                            className="grid grid-cols-[1fr_60px_80px_80px_32px] items-center gap-2"
                                        >
                                            <Input
