...
export default function AdminLecturersEdit({
    lecturer,
    departments = [],
    faculties = [],
}: AdminLecturersEditProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        date_of_birth: lecturer.date_of_birth
            ? String(lecturer.date_of_birth).split('T')[0]
            : '',
        address: lecturer.address ?? '',
        hire_date: lecturer.hire_date
            ? String(lecturer.hire_date).split('T')[0]
            : '',
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                            Update profile details for {lecturer.user?.name} (
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setData('lecturer_no', e.target.value)
                                    }
                                    required
                                />
                                {errors.lecturer_no && (
