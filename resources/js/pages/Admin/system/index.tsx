                                ...
                                <div className="grid grid-cols-1 gap-4 pt-2 md:grid-cols-2">
                                    ...
                                    <div className="flex items-center gap-3 pt-6">
                                        <input
                                            ...
                                            checked={
                                                data.student_registration_enabled
                                            }
                                            onChange={(e) =>
                                                setData(
                                        ...
                                        />
                                        <Label
                                            htmlFor="student_registration_enabled"
                                    ...
                                    <div className="flex items-center gap-3">
                                        <input
                                            ...
                                            checked={
                                                data.course_enrollment_open
                                            }
                                            onChange={(e) =>
                                                setData(
                                                    'course_enrollment_open',
                                                    e.target.checked,
                                                )
                                            }
                                            className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary"
                                        />
                                        <Label
                                            htmlFor="course_enrollment_open"
                                            className="cursor-pointer text-xs"
                                        >
                            ...
                            >
                                <div className="divide-y divide-border/30 pt-1 text-xs">
                                    ...
                                    <div className="flex justify-between py-2">
                                        ...
                                        <Badge className="bg-emerald-500/10 text-[10px] text-emerald-700 uppercase">
