...
export default function FinanceExpensesIndex({
    ...
    const handleFilterUpdate = (newFilters: Partial<typeof filters>) => {
        ...
        router.get('/finance/expenses', cleanQuery, {
            preserveState: true,
            preserveScroll: true,
        });
    };
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        ...
                        <p className="mt-0.5 text-xs text-muted-foreground">
                            Track salary, utilities, equipment, maintenance, and
                            supply expenses across departments.
                        </p>
                    </div>
                    ...
                    <DialogContent className="sm:max-w-lg">
                        ...
                        >
                            ...
                            <div className="space-y-1.5">
                                ...
                                <textarea
                                    className="min-h-[70px] w-full rounded-md border border-input bg-background px-3 py-2 text-xs shadow-sm focus:ring-1 focus:ring-ring focus:outline-none"
